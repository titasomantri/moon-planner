...
<html lang="en">
  <head>
    ...
    <title>Moon Planner Page Customer</title>
...
<ul>
<li style="background-color:#ff8800;"><a href="../../logoutcustomer.php"><span class="glyphicon glyphicon-log-out">Keluar</span></a></li>
</ul>
          </li>
    ...
    <div class="container">
     ...
     include"../../conn.php";
      ...
      ?>
        ...
        <?php } }
        else{ while($buku1 = mysqli_fetch_assoc($qrybukukat)){?>
            <div class="col-md-3" style="margin-top:20px;">
        <div class="buku">
